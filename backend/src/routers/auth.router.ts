...
import { LoginController, LoginWithGoogleController, RegisterController, RegisterWithGoogleController, SetPasswordController, VerifyAccountController } from "../controllers/auth.controller";
const router = Router();
